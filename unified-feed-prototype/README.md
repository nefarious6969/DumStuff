...
The sample posts remain local demo data. Real X access needs an approved API/OAuth integration, and Reddit feed access should use its documented API/OAuth flow.
